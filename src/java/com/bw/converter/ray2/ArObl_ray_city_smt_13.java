...
////  4 ступени адреса:  Область(или АР) --- Район --- Сільрада --- Село/селище 
 //  В этой ветке всего 1 запись?

public class ArObl_ray_city_smt_13 {
    ...
    public static void main(String args[]) throws SQLException {
        ArObl_ray_city_smt_13 o1 = new ArObl_ray_city_smt_13();
        bShowList = true;
        o1.getData();
    }
...
//            System.out.println(temp); }
   ...
   // for (int i = 0; i <= 2000/*list1.size()-1*/; i++) {              /*проходимся по списку КОАТУ*/
       ...
       if (list1.get(i).substring(3, 10).equals("0000000")        // если это 2 ступень - Районы области
        ...
        //========================================================  
        // СЕЛИЩА МІСЬКОГО ТИПУ, ПІДПОРЯДКОВАНІ БАХЧИСАРАЙСЬКІЙ МІСЬКРАДІ [0120445000]
         if ("45000".equals(list1.get(i).substring(5, 10)) // если это 4 ступень - МІСТА  Районов
            ...
            TypeRegion4 = "10";                     // 12 = Тип СМТ пустышка в PlaceRegionType
         ...
         //-----------------------------------------------------
        // смт НАУЧНИЙ [0120445100]
        if      ( "45".equals(list1.get(i).substring(5, 7)) 
                &  !"00".equals(list1.get(i).substring(7, 9))   // если это 7 ступень - конкр. полис смт НАУЧНИЙ
