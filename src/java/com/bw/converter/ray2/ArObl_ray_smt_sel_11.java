...
public class ArObl_ray_smt_sel_11 {
    ...
    public static void main(String args[]) throws SQLException {
        ArObl_ray_smt_sel_11 o1 = new ArObl_ray_smt_sel_11();
        bShowList = true;
        o1.getData();
    }
   ...
   // for (int i = 0; i <= 2000/*list1.size()-1*/; i++) {              /*проходимся по списку КОАТУ*/
       ...
       if (list1.get(i).substring(3, 10).equals("0000000")        // если это 2 ступень - Районы области
        ...
        // СЕЛИЩА МІСЬКОГО ТИПУ ВЕРХНЬОДНІПРОВСЬКОГО Р-НУ [1221055000]
         if ("55000".equals(list1.get(i).substring(5, 10)) // если это 4 ступень - СЕЛИЩА МІСЬКОГО ТИПУ  Районов
        ...
        //-----------------------------------------------------
       // смт НОВОМИКОЛАЇВКА [1221055800]
         if (   ( "55".equals(list1.get(i).substring(5, 7))      // если это 5 ступень - Конкретная смт
         ...
         //-----------------------------------------------------
        // с БРАТСЬКЕ [1221055801]
        if      (  ("55".equals(list1.get(i).substring(5, 7))    // если это 7 ступень - ПОЛИС (село, селение)
                   |"56".equals(list1.get(i).substring(5, 7)) 
                   |"57".equals(list1.get(i).substring(5, 7)) 
                   |"58".equals(list1.get(i).substring(5, 7)) 
                   |"59".equals(list1.get(i).substring(5, 7))  )
