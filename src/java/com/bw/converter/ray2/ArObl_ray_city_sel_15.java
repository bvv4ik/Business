...
public class ArObl_ray_city_sel_15 {
    ...
    public static void main(String args[]) throws SQLException {
        ArObl_ray_city_sel_15 o1 = new ArObl_ray_city_sel_15();
        bShowList = true;
        o1.getData();
    }
...
//            System.out.println(temp); }
        ...
        for (int i = 0; i <= list1.size() - 1; i++) {                     /*проходимся по списку КОАТУ*/
            ...
            //========================================================
            //ДНІПРОПЕТРОВСЬКА ОБЛАСТЬ/М.ДНІПРОПЕТРОВСЬК  1200000000
            ...
            //========================================================
            //  РАЙОНИ ДНІПРОПЕТРОВСЬКОЇ ОБЛАСТІ [1220000000]
            ...
            //========================================================  
            // МІСТА РАЙОННОГО ПІДПОРЯДКУВАННЯ ВЕРХНЬОДНІПРОВСЬКОГО Р-НУ [1221010000]
            if ("10000".equals(list1.get(i).substring(5, 10)) // если это 4 ступень - МІСТА РАЙОННОГО ПІДПОРЯДКУВАННЯ  Районов
            ...
            //-----------------------------------------------------
            // м ВЕРХІВЦЕВЕ [1221010300]
            if ("1".equals(list1.get(i).substring(5, 6)) // если это 5 ступень - Конкретная м ВЕРХІВЦЕВЕ
                    //    & !"00".equals(list1.get(i).substring(7, 9))   // это Конкретная смт
                    & "00".equals(list1.get(i).substring(8, 10)) // это не село 
            ...
            //-----------------------------------------------------
            // селище СОКОЛІВКА [1221010301]
            if ("1".equals(list1.get(i).substring(5, 6)) // если это 7 ступень - ПОЛИС (село, селение)
                    //  & !"00".equals(list1.get(i).substring(7, 9))   //  // это сельрада
