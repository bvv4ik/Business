...
//// 4 ступени адреса   Область(или АР) --- Район --- СМТ(Селищрада) --- Село/селище
public class Obl_ray_smt_sel {
    ...
    public static void main(String args[]) throws SQLException {
        Obl_ray_smt_sel o1 = new Obl_ray_smt_sel();
        bShowList = true;
        o1.getData();
    }
        ...
        for (int i = 0; i <= list1.size() - 1; i++) { /*проходимся по списку КОАТУ*/
            ...
            if ("55".equals(list1.get(i).substring(5, 7)) // если это 4 ступень - село, селище (подчиненное  СМТ)
                ...
                if ("С".equals(list2.get(i))) {
                    TypePolis7 = "3";
                }  // Тип Село в PlacePolisType
                if ("Щ".equals(list2.get(i))) {
                    TypePolis7 = "4";
                }  // Тип Селение   в PlacePolisType
