...
public class ArObl_city_city2 {
    ...
    public static void main(String args[]) throws SQLException {
        ArObl_city_city2 o1 = new ArObl_city_city2();
        bShowList = true;
        o1.getData();
    }
//  мавсамыма а
    ...
    public void getData() throws SQLException {
        ...
        for (int i = 0; i <= list1.size() - 1; i++) { /*проходимся по списку КОАТУ*/
            ...
            //-----------------------------------------------------
            //МІСТА, ПІДПОРЯДКОВАНІ ЯЛТИНСЬКІЙ МІСЬКРАДІ [0111970000]
            if (list1.get(i).substring(5, 10).equals("70000") // если это 4 ступень - МІСТА, ПІДПОРЯДКОВАНІ ЯЛТИНСЬКІЙ МІСЬКРАДІ
                    & list1.get(i).substring(2, 3).equals("1")) {       // !!! ищем только в Городах Области и АР
            ...
            if (list1.get(i).substring(5, 7).equals("70") // если это 4 ступень - конкретній Город АЛУПКА 
                    & !list1.get(i).substring(7, 9).equals("00") // Это город 
                    & list1.get(i).substring(2, 3).equals("1") // !!! ищем только в Городах Области и АР
                    & list1.get(i).substring(8, 10).equals("00")) {   // Это город а не село


                TypePolis7 = "1";                      // 1 =  тип "Город" в PlacePolisType

                /*Вывод на екран 5-х таблиц, 4  региона и 1 полиса*/
                if (bShowList) {
                ...
                ////////Что делать с городом, который является последним в цепочке, как и куда добавить 
                //////// его Миськраду, и с чем ее связать. нужно ли это?
