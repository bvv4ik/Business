...
public class ArObl_city_sel_14 {
    ...
    public static void main(String args[]) throws SQLException {
        ArObl_city_sel_14 o1 = new ArObl_city_sel_14();
        bShowList = true;
        o1.getData();
    }
//  мавсамыма а
    ...
    public void getData() throws SQLException {
        ...
        for (int i = 0; i <= list1.size() - 1; i++) { /*проходимся по списку КОАТУ*/
            ...
            //========================================================
            //ВІННИЦЬКА ОБЛАСТЬ/М.ВІННИЦЯ  0500000000
            ...
            //-----------------------------------------------------
            // МІСТА ОБЛАСНОГО ПІДПОРЯДКУВАННЯ ВІННИЦЬКОЇ ОБЛАСТІ [0510000000]
            if (list1.get(i).substring(3, 10).equals("0000000") // если это 2 ступень -  // МІСТА АВТОНОМНОЇ РЕСПУБЛІКИ КРИМ [0110000000]
                ...
                /*  ??Міста какие типа???*/
                TypeRegion2 = "10";                      // 10 = тип "Міста" автономної 
            ...
            //-----------------------------------------------------
            //м МОГИЛІВ-ПОДІЛЬСЬКИЙ [0510400000]             
            if ((list1.get(i).equals("4410160300"))
                    | (list1.get(i).substring(5, 10).equals("00000") // если это 3 ступень - конкретный город Ялта
                    & list1.get(i).substring(2, 3).equals("1") // !!! ищем только в Городах Области и АР
                    )) {
            ...
            //-----------------------------------------------------
            //  СЕЛИЩА, ПІДПОРЯДКОВАНІ МОГИЛІВ-ПОДІЛЬСЬКИЙ МІСЬКРАДІ [0510490000]
            if ((list1.get(i).substring(5, 7).equals("90") // если это 4 ступень - СЕЛА, ПІДПОРЯДКОВАНІ
                    | list1.get(i).substring(5, 7).equals("91")
                    | list1.get(i).substring(5, 7).equals("40") // населени пункти
                    )
                    & list1.get(i).substring(7, 10).equals("000")
                    & list3.get(i).contains("МІСЬКРАДІ")
                    //  &  list3.get(i).contains("НАСЕЛЕНІ ПУНКТИ,")
                    //   |  list3.get(i).contains("СЕЛИЩА,")
                    // &  !list3.get(i).contains("СІЛЬРАДИ")
                    // |  list3.get(i).contains("СЕЛА,")
            ...
            //-----------------------------------------------------
            //  селище ОДАЯ [0510490001]

            //String s = list1.get(i).substring(7, 9);
            if ((list1.get(i).equals("5110890101")
                    | list1.get(i).equals("5110890301")
                    | list1.get(i).equals("3211600001")
                    | list1.get(i).equals("3211600002")
                    | list1.get(i).equals("4410160301")
                    | list1.get(i).equals("4410160303"))
                    | ((list1.get(i).substring(5, 7).equals("90") // если это 7 ступень - конкретній СМТ ЗАОЗЕРНЕ                      
                    | list1.get(i).substring(5, 7).equals("40"))
                    & list1.get(i).substring(6, 8).equals("00") // Это город 
                ...
                //  aPlaceRegionTree.add(NameRegion1 +" "+NameRegion2 +" "+NameRegion3 +" "+NameRegion4  );
                //  aPlaceRegionTree.add("------------------------------");
