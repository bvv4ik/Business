...
public class ArObl_city_smt_sel4 {
    ...
    public static void main(String args[]) throws SQLException {
        ArObl_city_smt_sel4 o1 = new ArObl_city_smt_sel4();
        bShowList = true;
        o1.getData();
    }
//  мавсамыма а
    ...
    public void getData() throws SQLException {
        ...
        for (int i = 0; i <= list1.size() - 1; i++) { /*проходимся по списку КОАТУ*/
            ...
            //-----------------------------------------------------
            //  СЕЛИЩА МІСЬКОГО ТИПУ, ПІДПОРЯДКОВАНІ ДЗЕРЖИНСЬКІЙ МІСЬКРАДІ [1411245000]
            ...
            //-----------------------------------------------------
            // смт КІРОВЕ [1411245300]

            //String s = list1.get(i).substring(7, 9);



            if ((list1.get(i).equals("4412746000"))
                    | ((list1.get(i).substring(5, 7).equals("45") // если это 5 ступень - конкретній смт КІРОВЕ   
                ...
                TypeRegion5 = "7";                     // здесь заменяем на  "Селищрада СМТ"
            ...
            //-----------------------------------------------------
            //  селище ГОРЬКОГО [1411245301]
            //String s = list1.get(i).substring(7, 9);
            if ((list1.get(i).equals("1414448001")
                    | list1.get(i).equals("1414448003")
                    | list1.get(i).equals("1415346001")
                    | list1.get(i).equals("1415346003")
                    | list1.get(i).equals("4412346001")
                    | list1.get(i).equals("4412346003")
                    | list1.get(i).equals("4412746002") //1411390001
                    )
                    | ((list1.get(i).substring(5, 7).equals("45") // если это 7 ступень - конкретній смт ЗАОЗЕРНЕ   
                    | list1.get(i).substring(5, 7).equals("46")
                    | list1.get(i).substring(5, 7).equals("47")
                    | list1.get(i).substring(5, 7).equals("48")
                    | list1.get(i).substring(5, 7).equals("49")
