...
public class ArObl_city_rayGor_smt_sel {
    ...
    public static void main(String args[]) throws SQLException {
        ArObl_city_rayGor_smt_sel o1 = new ArObl_city_rayGor_smt_sel();
        bShowList = true;
        o1.getData();
    }
//  мавсамыма а
...
//sNamePolis = arrName.get(i).substring(0,4);
            ...
            // СЕЛИЩА МІСЬКОГО ТИПУ, ПІДПОРЯДКОВАНІ ЗАЛІЗНИЧНІЙ РАЙРАДІ М.СІМФЕРОПОЛЯ [0110165000]
            if (list4.get(i).substring(0, 1).equals("2") // если это 6 ступень - СЕЛИЩА МІСЬКОГО ТИПУ району... 
...
//                                                                       
            ...
            if ( //  list4.get(i).equals("1")                             // если это 6.1 ступень - конкретній смт     
                    list4.get(i).substring(0, 1).equals("3")
                    //  &  !list1.get(i).substring(7, 8).equals("0")
                    & list1.get(i).substring(2, 3).equals("1") // !!! ищем только в Городах Области и АР
                    ) {

                TypeRegion61 = "7";              // 7 - здесь заменяем на селищрада
                NameRegion61 = list3.get(i);              // запоминаем название    
                IdRegion61 = Integer.toString(i + 1);               // назначаем ИД для Области
                IdCoatuu61 = list1.get(i);
            ...
            if ( //  list4.get(i).equals("1")                             // если это 7 ступень - конкретній смт     
                    list4.get(i).substring(0, 1).equals("4")
                    //  &  !list1.get(i).substring(7, 8).equals("0")
                    & list1.get(i).substring(2, 3).equals("1") // !!! ищем только в Городах Области и АР

                    & !list1.get(i).contains("4410160301")
                    & !list1.get(i).contains("4410160303")
                    & !list1.get(i).contains("6510192501")
                    & !list1.get(i).contains("5910191501")
                    & !list1.get(i).contains("5910191503")
                    & !list1.get(i).contains("5910191505")
                    & !list1.get(i).contains("5910191507")
                    & !list1.get(i).contains("5910191509")
                    & !list1.get(i).contains("5910191511")) {
                ...
                if (bShowList) {
                    sResultRow = "\n" + IdRegion1 + "\t" + 1 + "\t" + NameRegion1 + "\t" + TypeRegion1 + "\t" + IdCoatuu1
                            ...
                            + "\t\t" + IdRegion61 + "\t" + 1 + "\t" + NameRegion61 + "\t" + TypeRegion61 + "\t" + IdCoatuu61
                ...
                aPlaceRegion.add(IdRegion61 + "\t" + OtherMethods.getFirstName(NameRegion61) + "\t" + 1 + "\t" + TypeRegion6 + "\t" + OtherMethods.getLastNum(NameRegion61) + "\t" + IdCoatuu61 + "\t" + "0");
                ...
                //   aPlaceRegionTree.add("---------------------");               
                aPlaceRegionTree.add(IdRegion61 + "\t" + IdRegion6 + "\t" + (IdRegion1));
