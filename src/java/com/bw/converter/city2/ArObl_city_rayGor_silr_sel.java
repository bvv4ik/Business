...
public class ArObl_city_rayGor_silr_sel {
    ...
    public static void main(String args[]) throws SQLException {
        ArObl_city_rayGor_silr_sel o1 = new ArObl_city_rayGor_silr_sel();
        bShowList = true;
        o1.getData();
    }
//  мавсамыма а
...
//sNamePolis = arrName.get(i).substring(0,4);
            ...
            // СІЛЬРАДИ, ПІДПОРЯДКОВАНІ ----- РАЙРАДІ
            if (list4.get(i).substring(0, 1).equals("8") // если это 6 ступень - СЕЛИЩА МІСЬКОГО ТИПУ району... 
...
//                                                                       
            ...
            if ( //  list4.get(i).equals("1")                     // если это 6.1 ступень - конкретній сильрад
                    list4.get(i).substring(0, 1).equals("9")
                    //  &  !list1.get(i).substring(7, 8).equals("0")
                    & list1.get(i).substring(2, 3).equals("1") // !!! ищем только в Городах Области и АР
                    ) {

                TypeRegion61 = "8";              // 8 - сильрада
