...
////  4 ступени адреса:  Область(или АР) --- Город(селищрада) --- Сільрада --- Село/селище 
public class Obl_city_silr_sel {
    ...
    public static void main(String args[]) throws SQLException {
        Obl_city_silr_sel o1 = new Obl_city_silr_sel();
        bShowList = true;
        o1.getData();
    }
    ...
    public void getData() throws SQLException {
        ...
        for (int i = 0; i <= list1.size() - 1; i++) { /*проходимся по списку КОАТУ*/
            ...
            if ("9".equals(list1.get(i).substring(5, 6)) // если это ТРЕТЬЯ ступень - Сельрада
                    & !"00".equals(list1.get(i).substring(6, 8)) //
                    & "00".equals(list1.get(i).substring(8, 10))
                    & list1.get(i).substring(2, 3).equals("1") // убираем севастополь
                    ) {   // берем только название селрады
            ...
            if ("9".equals(list1.get(i).substring(5, 6)) & // если это 4 ступень - село, селение
                    !"00".equals(list1.get(i).substring(6, 8))
                    & !"00".equals(list1.get(i).substring(8, 10))
                    & list1.get(i).substring(2, 3).equals("1") // убираем севастополь
                    ) {
                ...
                if ("С".equals(list2.get(i))) {
                    TypePolis7 = "3";
                }  // выставляем Тип Села  в PlacePolisType
                if ("Щ".equals(list2.get(i))) {
                    TypePolis7 = "4";
                }  // выставляем Тип Селения   в PlacePolisType
