...
// Setters
    public PlaceRegionType _nID(int i) {
        nID = i;
        return this;
    }

    public PlaceRegionType _sRegionType(String s) {
        sRegionType = s;
        return this;
    }

    public PlaceRegionType _sRegionTypeShort(String s) {
        sRegionTypeShort = s;
        return this;
    }

    public PlaceRegionType _nRegionTypeOrder(int i) {
        nRegionTypeOrder = i;
        return this;
    }
    ...
    public String sRegionTypeShort() {
        return sRegionTypeShort;
    }

    public int nRegionTypeOrder() {
        return nRegionTypeOrder;
    }
