...
// Setters
    public PlacePolisType _nID(int i) {
        nID = i;
        return this;
    }

    public PlacePolisType _sPolisType(String s) {
        sPolisType = s;
        return this;
    }

    public PlacePolisType _nPlacePolisTypeOrder(int i) {
        nPlacePolisTypeOrder = i;
        return this;
    }
    ...
    public String sPolisType() {
        return sPolisType;
    }

    public int nPlacePolisTypeOrder() {
        return nPlacePolisTypeOrder;
    }
