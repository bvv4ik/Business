...
// Setters
    public TheSubjectHuman _nID(int i) {
        nID = i;
        return this;
    }

    public TheSubjectHuman _nID_TheSubject(int i) {
        nID_TheSubject = i;
        return this;
    }

    public TheSubjectHuman _sTheSubjectHuman(String s) {
        sTheSubjectHuman = s;
        return this;
    }

    public TheSubjectHuman _sLastName(String s) {
        sLastName = s;
        return this;
    }

    public TheSubjectHuman _sFirstName(String s) {
        sFirstName = s;
        return this;
    }

    public TheSubjectHuman _sSurName(String s) {
        sSurName = s;
        return this;
    }

    public TheSubjectHuman _sDTbirth(String s) {
        sDTbirth = s;
        return this;
    }

    public TheSubjectHuman _sDTdeath(String s) {
        sDTdeath = s;
        return this;
    }

    public TheSubjectHuman _nSex(int n) {
        nSex = n;
        return this;
    }
    ...
    public String sTheSubjectHuman() {
        return sTheSubjectHuman;
    }
    ...
    public String sDTbirth() {
        return sDTbirth;
    }

    public String sDTdeath() {
        return sDTdeath;
    }
