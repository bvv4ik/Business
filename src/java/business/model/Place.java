...
// Setters
    public Place _nID(int i) {
        nID = i;
        return this;
    }

    public Place _nID_Contact(int i) {
        nID_Contact = i;
        return this;
    }

    public Place _nID_Product(int i) {
        nID_Product = i;
        return this;
    }

    public Place _nID_PlaceCell(int i) {
        nID_PlaceCell = i;
        return this;
    }

    public Place _nID_PlacePart(int i) {
        nID_PlacePart = i;
        return this;
    }

    public Place _nID_PlaceBuild(int i) {
        nID_PlaceBuild = i;
        return this;
    }

    public Place _sPlace(String s) {
        sPlace = s;
        return this;
    }
    ...
    public int nID_Product() {
        return nID_Product;
    }

    public int nID_PlaceCell() {
        return nID_PlaceCell;
    }

    public int nID_PlacePart() {
        return nID_PlacePart;
    }
