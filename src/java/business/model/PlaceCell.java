...
// Setters
    public PlaceCell _nID(int i) {
        nID = i;
        return this;
    }

    public PlaceCell _nID_PlacePart(int i) {
        nID_PlacePart = i;
        return this;
    }

    public PlaceCell _nID_PlaceCellType(int i) {
        nID_PlaceCellType = i;
        return this;
    }

    public PlaceCell _nLevel(int i) {
        nLevel = i;
        return this;
    }

    public PlaceCell _nCell(int i) {
        nCell = i;
        return this;
    }

    public PlaceCell _sCell(String s) {
        sCell = s;
        return this;
    }
    ...
    public int nID_PlaceCellType() {
        return nID_PlaceCellType;
    }
