...
import  business.model.PlaceRegionType;
import business.model.PlacePolisType;
import business.model.PlaceBuild;
import business.model.PlacePolis;
import business.model.PlaceCell;
import business.model.PlaceCountry;
import business.model.PlacePart;
import business.model.PlaceBuildType;
import business.model.PlaceRegion;
import business.model.Place;
import business.model.PlaceArea;
import business.model.PlaceBranch;
...
import business.model.PlaceBranchType;
import business.model.PlaceCellType;

//import zLogic.Registration1;
//import com.bw.io.AccessLDAP;
...
//======================================================================
  ...
  if ("UserLogining".equals(sDO)) {
      ...
      if (!AccessLDAP.isLoginExists(sLoginEnter)) {
          sReturnLogin = "{\"sReturnLogin\":\"Неверный Логин\"}";
      }

      // если логин есть то берем пароль
      String s = AccessLDAP.sGetPassword(sLoginEnter);
