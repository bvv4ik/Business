...
//-      DOMConfigurator.configure("D:/My Documents/NetBeansProjects/Business/web/WEB-INF/config/log4j.xml");
          ...
          try {
               ...
               } else {   // ТРЕВОГА !!! возвращаем нули вместо паролей
                    list1.add("0");
                    list1.add("0");
                    oLog.info(" ALERT! ПОПЫТКА ВЗЛОМА! Ложная КУКА! Код куки не совпадает ни с одним из находящихся в Базе! IP злоумышленника : " + IpUser);
